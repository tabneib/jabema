...
echo "unit.type                 = Java"
echo "unit.target               = "$path_to_utils_encapsulation"target/server-sidechannel.jar"
echo "unit.target-javavm        = /usr/bin/java"
echo "unit.pointcuts            = "$path_to_utils_encapsulation"target/server-sidechannel.pc"
